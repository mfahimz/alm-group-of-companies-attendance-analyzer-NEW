...
import { Shield, AlertTriangle, Activity, Users, FolderKanban, Building2, FileText, ArrowRight, Settings, DollarSign } from 'lucide-react';
                    ...
                    <CardContent>
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <Link to={createPageUrl('Users')}>
                                <Button variant="outline" className="w-full h-auto py-3 flex flex-col items-center gap-1.5 hover:bg-purple-50 hover:border-purple-200">
                        ...
                        {auditLogs.length === 0 ? (
                            ...
                            auditLogs.map((log) => (
                                <div key={log.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 transition-colors">
                                    <div className="bg-slate-100 text-slate-600 p-1.5 rounded-lg flex-shrink-0">
