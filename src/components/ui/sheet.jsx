...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-white p-6 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out shadow-2xl shadow-slate-200/40 ring-1 ring-slate-200",
  {
    variants: {
      side: {
  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content 
      ...
      <SheetPrimitive.Close
        className="absolute right-4 top-4 rounded-sm text-slate-400 transition-colors hover:text-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-100 focus:ring-offset-2 disabled:pointer-events-none z-10">
        <X className="h-4 w-4" />
