...
// Full interactive payroll table for Body Shop employees (department === 'Bodyshop')
// Exact replica of BranchPayrollTab — only difference is the department filter
// All state and logic passed as props — no internal calculations or entity fetches
...
export default function BodyShopPayrollTab({
    ...
    const grandTotals = useMemo(() => {
        return bodyShopData.reduce((acc, row) => {
            const { total, wpsPay, balance, netAdditions, netDeductions, normalOtSalary, specialOtSalary, totalOtSalary } = calculateTotals(row);
    ...
    }, [bodyShopData, calculateTotals, getValue]);
