                                ...
                                <section className="space-y-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="space-y-4 border-l-4 border-indigo-500 pl-6">
                                            ...
                                            <p className="text-sm text-[#4A5568] leading-relaxed">
                                                The <strong>Audit Panel</strong> detects and flags "Problem Days." These include days with mismatching punch counts, extreme lateness, or where the analysis system had to "guess" a punch's boundary (Extended Matches). <em>Note: The audit panel now handles shifts ending up to 01:59 AM as midnight crossovers and includes a fallback to exclude early morning buffer punches for employees with missing Saturday or previous day shift configurations. This ensures high accuracy in mismatch detection even for irregular project schedules.</em> This ensures supervisors focus on high-risk discrepancies rather than reviewing thousands of perfect records.
                                            </p>
                                        </div>
