                                ...
                                <section className="space-y-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="space-y-4 border-l-4 border-indigo-500 pl-6">
                                            ...
                                            <p className="text-sm text-[#4A5568] leading-relaxed">
                                                The <strong>Audit Panel</strong> detects and flags "Problem Days." These include days with mismatching punch counts, extreme lateness, or where the analysis system had to "guess" a punch's boundary (Extended Matches). <em>Note: The audit panel now ensures correct employee name resolution in group headers and gates next-day buffer punches to only include them for shifts ending near midnight. This eliminates false mismatch flags for standard daytime shifts while maintaining precision for night shifts.</em> This ensures supervisors focus on high-risk discrepancies rather than reviewing thousands of perfect records.
                                            </p>
                                        </div>
