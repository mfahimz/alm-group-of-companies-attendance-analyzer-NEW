                                ...
                                <section className="space-y-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="space-y-4 border-l-4 border-indigo-500 pl-6">
                                            ...
                                            <p className="text-sm text-[#4A5568] leading-relaxed">
                                                The <strong>Audit Panel</strong> detects and flags "Problem Days." These include days with mismatching punch counts, extreme lateness, or where the analysis system had to "guess" a punch's boundary (Extended Matches). <em>Note: The Shift Mismatch Analysis tools now include bidirectional midnight carry-forward logic to correctly distinguish between consecutive shifts. This matches the backend analysis engine's precision by ensuring early-morning punch-outs are assigned only to their true shift. Additionally, the <strong>Fix Entry</strong> and <strong>Edit</strong> buttons now utilize fully synchronized punch data including crossover buffers, and the panel correctly suppresses any date covered by verified exceptions (leaves, holidays, manual entries) across all types.</em> This ensures supervisors focus on high-risk discrepancies rather than reviewing thousands of perfect records.
                                            </p>
                                        </div>
