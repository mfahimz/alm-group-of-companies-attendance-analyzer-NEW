...
export default function ReportDetailPage() {
    ...
    return (
        <div className="space-y-5 max-w-[1900px] mx-auto">
            {/* Header */}
            <div className="bg-white border border-slate-200 rounded-xl px-5 sm:px-6 py-4 shadow-sm">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start gap-4 min-w-0">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-slate-500">
                                <span>Generated: {formatInUAE(reportRun.created_date?.endsWith('Z') ? reportRun.created_date : (reportRun.created_date + 'Z'), 'MM/dd/yyyy hh:mm a')}</span>
                                <span>Period: {formatInUAE(reportRun.date_from, 'MM/dd/yyyy')} - {formatInUAE(reportRun.date_to, 'MM/dd/yyyy')}</span>
                            </div>
                        </div>
                    </div>
