...
export default function HalfYearlyMinutesManagement() {
    ...
    // Old structure: { quarter: 1|2|3|4 } — Q1=Jan-Mar, Q2=Apr-Jun, Q3=Jul-Sep, Q4=Oct-Dec
    // New structure: { half: 1|2 }       — H1=Jan-Jun, H2=Jul-Dec
    ...
    // Filter and sort — all references use the `half` field, not `quarter`
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        variant="destructive"
                        onClick={() => {
                            // Invalid records: missing year or half (not quarter — migrated to half-yearly)
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <SortableTableHead label="HRMS ID" sortKey="employee_id" currentSort={sortConfig} onSort={handleSort} />
                                    <SortableTableHead label="Att ID" sortKey="employee_attendance_id" currentSort={sortConfig} onSort={handleSort} />
                                    <SortableTableHead label="Name" sortKey="employee_name" currentSort={sortConfig} onSort={handleSort} />
                                    {isAdminOrCEO && (
                                        <SortableTableHead label="Company" sortKey="employee_company" currentSort={sortConfig} onSort={handleSort} />
                                    )}
                                    <SortableTableHead label="Department" sortKey="employee_department" currentSort={sortConfig} onSort={handleSort} />
                                    <SortableTableHead label="Year" sortKey="year" currentSort={sortConfig} onSort={handleSort} />
                                    <SortableTableHead label="Half-Year" sortKey="half" currentSort={sortConfig} onSort={handleSort} />
                                    <SortableTableHead label="Total Minutes" sortKey="total_minutes" currentSort={sortConfig} onSort={handleSort} />
                                    <SortableTableHead label="Used Minutes" sortKey="used_minutes" currentSort={sortConfig} onSort={handleSort} />
                                    <SortableTableHead label="Remaining" sortKey="remaining_minutes" currentSort={sortConfig} onSort={handleSort} />
                                    ...
                                    filteredAndSortedData.map(record => {
                                        ...
                                        return (
                                            <TableRow key={record.id} className={isSelected ? 'bg-blue-50' : ''}>
                                                ...
                                                {/* Half-Year cell: reads `half` field, displays H1 or H2 — never quarter values */}
                                                <TableCell>
                                                ...
                                                {/* Period cell: derived from `half` field — H1=Jan-Jun, H2=Jul-Dec */}
