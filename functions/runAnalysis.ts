...
Deno.serve(async (req) => {
    try {
        ...
        // Prevents running legacy project-based analysis when company uses calendar mode
        // ============================================================
        ...
        if (companySettings.length > 0 && companySettings[0].payroll_mode === 'CALENDAR') {
            return Response.json({ 
                error: `This company uses Calendar-based Payroll. Project-based analysis is disabled. Please use the Calendar module instead.`,
